...
from .views import ask_question_api, write_director_api, about_api, info_api, banner_api, our_team_api, slide_api, request_price_api
...
urlpatterns = [
    ...
    path('address/', info_api),
    path('banner/', banner_api),
]